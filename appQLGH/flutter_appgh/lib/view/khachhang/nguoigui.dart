...
import 'nguoinhan.dart';

class nguoigui extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _nguoiguiState();
}

class _nguoiguiState extends State<nguoigui> {
  List<donhangModel> dsDonHang = <donhangModel>[];
  Future<List<donhangModel>> _fetchAllDH(String sdt) async {
  ...
  void addList(String sdt) async {
    var a = await _fetchAllDH(sdt);
    setState(() {
      dsDonHang = a;
    });
  }
            ...
            onSelected: (String value) {
              ...
              if (value == "nhan") {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => nguoinhan()));
              }
            },
          ),
        ],
